...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/verifiable_credential.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/core_terms_1.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/core_terms_2.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/core_terms_3.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/core_terms_4.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/core_terms.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/pre-authorized_code_flow_1.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/pre-authorized_code_flow_2.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/pre-authorized_code_flow_2.png)

In return, the wallet receives an access token.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/pre-authorized_code_flow_3.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/pre-authorized_code_flow_4.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/pre-authorized_code_flow_4.png)

In return, the wallet receives a verifiable credential.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/pre-authorized_code_flow_5.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/pre-authorized_code_flow_5.png)

The diagram below is an overview of the pre-authorized code flow.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/pre-authorized_code_flow.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow_1.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow_2.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow_3.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow_3.png)

In return, the client application receives an access token.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow_4.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow_5.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow_5.png)

In return, the client application receives a verifiable credential.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow_6.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow_6.png)

The diagram below illustrates the authorization code flow followed by the credential issuance.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow.png)
...
1. The `authorization_details` request parameter.
1. The `scope` request parameter.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_request_parameters.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow+issuer_state_1.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow+issuer_state_2.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow+issuer_state_2.png)

The remaining part after the authorization request is the same as that of the normal authorization code flow.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow+issuer_state_3.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow+issuer_state_3.png)

The diagram below illustrates the authorization code flow with an issuer state.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow+issuer_state.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow+authorization_details_1.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow+authorization_details_2.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow+scope_1.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow+scope_2.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authorization_code_flow+scope_3.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/deferred_issuance_1.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/deferred_issuance_1.png)

The credential issuer issues the requested verifiable credential as a response.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/deferred_issuance_2.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/deferred_issuance_3.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/deferred_issuance_4.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/deferred_issuance_4.png)

The credential issuer issues the requested verifiable credential as a response.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/deferred_issuance_5.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_issuance_1.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_issuance_1.png)

The endpoint returns multiple verifiable credentials and/or transaction IDs.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_issuance_2.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_issuance_2.png)

Each transaction ID can be used to obtain a verifiable credential from the deferred credential endpoint.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_issuance_3.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_issuance_01.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_issuance_02.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_issuance_02.png)

A credential offer contains other information, too. It always contains the identifier of the credential issuer.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_issuance_03.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_issuance_03.png)

Also, a credential offer contains information about the verifiable credentials that the credential issuer offers.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_issuance_04.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_issuance_05.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_issuance_06.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_issuance_07.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_issuance_08.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_issuance_08.png)

By accessing the URI,

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_issuance_09.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_issuance_09.png)

the wallet can obtain the content of the issued credential offer.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_issuance_10.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_content_1.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_content_1.png)

The identifier of the credential issuer is put as the value of the `"credential_issuer"` property.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_content_2.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_content_3.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_content_4.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_content_5.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_content_6.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_content_6.png)

The diagram below illustrates an overview of the structure of the content of a credential offer.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_content.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_credential_configuration_ids.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/issuable_credential_01.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/issuable_credential_02.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/issuable_credential_03.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/issuable_credential_04.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/issuable_credential_05.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/issuable_credential_05.png)

A RAR object with the openid_credential type may use the `format` property instead.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/issuable_credential_06.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/issuable_credential_07.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/issuable_credential_08.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/issuable_credential_08.png)

The diagram below illustrates the overall picture of the mechanisms to specify issuable credentials.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/issuable_credential.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/issuable_credential.png)

You might be curious about the structures of the credential information and the RAR object in the diagram.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/issuable_credential_09.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_01.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_01.png)

To sign the data, the credential issuer prepares a pair of a private key and a public key.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_02.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_02.png)

Then, the credential issuer signs the data with the private key. As a result, a signature is generated.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_03.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_03.png)

The set of the data and the signature is a verifiable credential.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_04.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_04.png)

The credential issuer passes the verifiable credential to the wallet.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_05.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_06.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_07.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_08.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_09.png)
...
1. The verifiable credential underlying the verifiable presentation has been issued by the credential issuer to the holder.

As for the first point, it can be achieved by having the holder provide a pair of a private key and a public key,

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_10.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_11.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_12.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_13.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_13.png)

If the credential issuer can validate the presented public key, it can create a verifiable credential with key binding.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_14.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_14.png)

The verifiable credential is then passed to the wallet,

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_15.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_16.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_16.png)

The verifiable presentation is then passed to the verifier.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_17.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_18.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification_18.png)

The following diagram illustrates the overall picture of the credential verification explained so far.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_verification.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/selective_disclosure_1.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/selective_disclosure_2.png)
...
1. Monetary costs for licensing.
1. Legal restrictions on usage.
1. Support from Hardware Security Module (HSM) products.
1. How much the industry believes the algorithm is robust/secure.
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_01.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_01.png)

To make such a claim “selectively-disclosable” using the SD-JWT format, you first extract the claim.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_02.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_02.png)

Then, you add an arbitrary salt to it,

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_03.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_03.png)

and create a JSON array including the salt, the claim name and the claim value.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_04.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_05.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_06.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_06.png)

The same process is applied to other claims that need to be made selectively-disclosable.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_07.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_07.png)

By concatenating the “**issuer-signed JWT**” with the disclosures using tildes (`~`), a single string is formed.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_08.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_08.png)

This resulting string is an SD-JWT.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_09.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_09.png)

The next step is optional, but if you want to perform key binding, please prepare a key pair.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_10.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_10.png)

Then, embed the public key into the issuer-signed JWT,

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_11.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_12.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_12.png)

The following diagram illustrates the overall process of generating SD-JWT that we have explained so far.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/sd-jwt_13.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_configuration.png)
...
1. The `x5c` header parameter ([RFC 7515, 4.1.6](https://www.rfc-editor.org/rfc/rfc7515.html#section-4.1.6))
1. The `kid` header parameter ([RFC 7515, 4.1.4](https://www.rfc-editor.org/rfc/rfc7515.html#section-4.1.4))

All of these methods embed the key information in the header of a key proof JWT.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/key_proof_jwt_1.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/key_proof_jwt_2.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/key_proof_jwt_2.png)

The value of the `jwk` header parameter is a JSON object representing the public key.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/key_proof_jwt_3.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/key_proof_jwt_3.png)

The key proof JWT itself must be signed with the private key that corresponds to the public key.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/key_proof_jwt_4.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/key_proof_jwt_5.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/key_proof_jwt_6.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/key_proof_jwt_6.png)

Next, let’s take a look at the payload part of a key proof JWT.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/key_proof_jwt_7.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/key_proof_jwt_8.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/c_nonce_1.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/c_nonce_1.png)

The wallet uses the value of the `c_nonce` response parameter as the value of the `nonce` claim in a key proof JWT.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/c_nonce_2.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/c_nonce_2.png)

The wallet includes the key proof JWT in a credential request.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/c_nonce_3.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/c_nonce_4.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/c_nonce_5.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/c_nonce_5.png)

The diagram below provides an overview of `c_nonce`.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/c_nonce.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_request_1.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_request_2.png)
...
1. There’s a possibility that multiple issuable credentials may satisfy the conditions.
1. Minor differences in conditions can lead to the selection of a different issuable credential.
1. It’s not easy to confirm whether the presented access token has the permission to request verifiable credentials that meet the specified conditions.
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_request_3.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_request_4.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_request_4.png)

The diagram below is an overview of a credential request.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_request.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_response_1.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_response_2.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_response_3.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_response_3.png)

Let’s dive into some details of an SD-JWT-based verifiable credential.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_response_4.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_response_5.png)
...
1. The payload contains `"cnf"."jwk"` for key binding.
1. The payload contains the `"_sd_alg"` property, which indicates the hash algorithm used for disclosures.
1. The payload does not contain user claims like `"given_name"`. Instead, it contains the `"_sd"` array, which holds digest values of disclosures for user claims.

The example of SD-JWT-based verifiable credential contains four disclosures.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_response_6.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_response_6.png)

By base64url-decoding the disclosures, the original JSON arrays will appear.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_response_7.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_response_8.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_response_8.png)

The diagram below is an overview of a credential response with an SD-JWT-based verifiable credential.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_response.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_credential_request_1.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_credential_request_1.png)

Each credential request contains credential information and may contain an optional key proof.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_credential_request_2.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_credential_request_3.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_credential_request_3.png)

The diagram below is an overview of a batch credential request.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_credential_request.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_credential_response_1.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_credential_response_1.png)

Each credential response contains either a verifiable credential or a transaction ID.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_credential_response_2.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_credential_response_3.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_credential_response_3.png)

The diagram below is an overview of a batch credential response.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/batch_credential_response.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/key_distribution_oidfed.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/key_distribution_jwt_vc_issuer.png)
...
Developers can build their own credential issuers and authorization servers /
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/oid4vci_parties_and_authlete.png)
...
1. **Full control over end-user facing frontend servers**

Corporate brand management across all aspects of UI/UX.
1. **Enforced proper layer separation in system design**
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authlete_release_history_up_to_3_0.png)
...
| credentialResponseEncryptionAlgValuesSupported | stringarray | The JWE alg algorithms supported for credential response
      ...
      The valid values are the names of JWEAlg enum entries such as "ECDH_ES".
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/authlete_apis_for_oid4vci.png)
...
Developers can obtain access tokens for Authlete APIs using the new Web console,
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_qr.png)
...
| context | The general-purpose arbitrary string associated with the credential
      ...
      Developers can utilize this parameter as they like. Authlete does not
...
1. `?credential_offer=`.
1. URL-encoded `"credentialOffer"` value.
...
1. A credential offer endpoint. For example, `openid-credential-offer://`.
1. `?credential_offer_uri=`.
1. URL-encoded URL of the endpoint including the identifier of the credential offer. For example, https://trial.authlete.net/api/offer/9gjVvas8Q5BkkrkSfZv-DbsBYJvlw6ZPMK-TeCkQDEc.
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_issue_page.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_endpoint_01.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_endpoint_02.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_endpoint_03.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_endpoint_04.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_endpoint_05.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_endpoint_06.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_endpoint_07.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_endpoint_08.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_endpoint_09.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_endpoint_09.png)

Finally, the credential endpoint returns the credential response to the wallet.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_endpoint_10.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_endpoint.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_issuance_order_1.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_issuance_order_2.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_issuance_order_3.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_issuance_order_4.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_issuance_order_5.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_issuance_order_6.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_issuance_order_7.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_issuance_order_8.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_issuance_order_9.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_issuance_order.png)
...
1. Click on your Organization name and choose your Service.
1. Navigate to Service Settings &gt; Verifiable Credentials &gt; General
1. Under the `Verifiable Credentials Feature` section, press `Enable` to turn on support for Verifiable Credentials.
1. Optionally, enable the `Anonymous Access` property if you want to allow token requests by unidentifiable client applications.
1. Click the `Save Changes` button to apply the updates.
...
1. Configure the metadata properties to suit your requirements. The following properties correspond to the metadata defined in the [OID4VCI specification](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html):
...
Configure the metadata properties to suit your requirements. The following properties correspond to the metadata defined in the [OID4VCI specification](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html):
...
1. Log in to the [Authlete Management Console](https://console.authlete.com/)
1. Click on your Organization name and choose your Service.
1. Navigate to Client Settings &gt; Verifiable Credentials &gt; General
1. Under the `Credential Response Encryption` section, enable `Require` option to turn on support for response encryption.
1. Click the `Save Changes` button to apply the updates.
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/credential_offer_issue_page_result.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/demo_mdoc_authorization_page.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/demo_mdoc_redirection_endpoint.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/demo_mdoc_cbor_zone.png)
...
| Redirect URIs | https://nextdev-api.authlete.net/api/mock/redirectioneudi-openid4ci://authorize/ |

1. `https://nextdev-api.authlete.net/api/mock/redirection``eudi-openid4ci://authorize/`
...
1. Edit the “Credential Configuration IDs”. The value should be a JSON array containing the string `potential.light.profile`.
1. Check the “include?” checkbox next to “Authorization Code Grant”.
1. Uncheck the “include?” checkbox next to “Pre-Authorized Code Grant”.

![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/potential_track1_light_credential_offer_form.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/potential_track1_light_credential_offer_qr_code.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/potential_track1_light_authorization_page.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/potential_track1_light_redirection_endpoint.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/potential_track2_light_authorization_page.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/potential_track2_full_authorization_page.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oid4vci/potential_track2_full_redirection_endpoint.png)
