...
- The initial version was published.

- Since the specification name was changed from OpenID Connect Federation 1.0
          to OpenID Federation 1.0, the text and diagrams have been updated accordingly.
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_overview_01.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_overview_02.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_overview_02.png)

The other is a trust chain for the identity provider to trust the relying party.

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_overview_03.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_overview_04.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_overview_05.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_overview_06.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_overview_06.png)

The diagram below illustrates an overview of OpenID Federation 1.0 that has been explained in this section.

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_overview.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_overview.png)

# Trust Chain

Technically speaking, a trust chain is a sequence of **JWT**s ([RFC 7519 JSON Web Token](https://www.rfc-editor.org/rfc/rfc7519.html)) that are issued by a leaf entity, zero or more intermediate authorities, and a trust anchor.

## JWT Issued by Leaf Entity

A leaf entity issues a JWT that is signed by the leaf entity’s private key.

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc_01.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc_02.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc_03.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc_04.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc_05.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc_05.png)

In addition, the `jwks` claim holds the public key of the leaf entity.

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc_06.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc_07.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc_08.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc_08.png)

The JWT issued by the trust anchor contains the public key of the last intermediate authority.

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc_09.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc_09.png)

A trust chain may optionally have one more JWT that is self-signed by the trust anchor at the end.

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc_10.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc_10.png)

As it is a self-signed JWT, both the `iss` claim and the `sub` claim hold the trust anchor’s identifier.

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc_11.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_ah_01.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_ah_02.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_ah_03.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_fetch_endpoint.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tcr_01.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tcr_02.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tcr_02.png)

**(3)** The entity configuration of the intermediate authority is needed to know the URL of its federation fetch endpoint.

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tcr_03.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tcr_04.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tcr_04.png)

**(5)** The federation fetch endpoint returns a JWT that indicates that the intermediate authority authorizes the leaf entity.

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tcr_05.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tcr_06.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tcr_06.png)

**(7)** The entity configuration of the trust anchor is needed to know the URL of its federation fetch endpoint.

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tcr_07.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tcr_08.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tcr_08.png)

**(9)** The federation fetch endpoint returns a JWT that indicates that the trust anchor authorizes the intermediate authority.

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tcr_09.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tcr_10.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tcr.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_md_idp.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_md_rp.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_md_ia.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_md_ia.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_md_ta.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_mp_01.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_mp_02.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_mp_02.png)

The metadata policies are combined before use.

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_mp_03.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_mp_04.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_mp_04.png)

The following diagram depicts the flow of metadata policy application.

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_mp.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_client_registration_types_supported_automatic.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_client_registration_types_automatic.png)
...
1. `private_key_jwt` - Client authentication using client assertion.
1. `tls_client_auth` - Client authentication using X.509 certificate.
1. `self_signed_tls_client_auth` - Client authentication using X.509 certificate.
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_request_authentication_methods_supported.png)
...
1. **Trust chain**, a JSON array listing entity statements. Its Content-Type is `application/trust-chain+json`.

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_explicit_registration_request.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_explicit_registration_response.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_server_metadata_for_explicit.png)

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_server_metadata_for_explicit.png)

Also, the `client_registration_types` client metadata of the client being explicitly registered must include `explicit`.

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_client_registration_types_explicit.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_tc_exp.png)
...
1. The `federationEnabled` flag of `Service` must be `true`. (cf. [Service.setFederationEnabled(boolean)](https://authlete.github.io/authlete-java-common/com/authlete/common/dto/Service.html#setFederationEnabled-boolean-))

Authlete Server must be deployed with `feature.oidc_federation.enabled=true`.

The `federationEnabled` flag of `Service` must be `true`. (cf. [Service.setFederationEnabled(boolean)](https://authlete.github.io/authlete-java-common/com/authlete/common/dto/Service.html#setFederationEnabled-boolean-))
...
1. At least one pair of trust anchor and its JWK Set must be registered. Otherwise, the service cannot trust any trust chain. (cf. [Service.setTrustAnchors(TrustAnchor[])](https://authlete.github.io/authlete-java-common/com/authlete/common/dto/Service.html#setTrustAnchors-com.authlete.common.dto.TrustAnchor:A-))
1. At least one private key dedicated to OpenID Federation must be registered. Otherwise, the service cannot sign entity statements. (cf. [Service.setFederationJwks(String)](https://authlete.github.io/authlete-java-common/com/authlete/common/dto/Service.html#setFederationJwks-java.lang.String-))
1. At least either of automatic client registration or explicit client registration must be supported. Otherwise, the service cannot register federation clients. (cf. [Service.setSupportedClientRegistrationTypes(ClientRegistrationType[])](https://authlete.github.io/authlete-java-common/com/authlete/common/dto/Service.html#setSupportedClientRegistrationTypes-com.authlete.common.types.ClientRegistrationType:A-))

At least one authority (intermediate authority or trust anchor) must be registered. Otherwise, the service cannot generate its entity configuration. (cf. [Service.setAuthorityHints(URI[])](https://authlete.github.io/authlete-java-common/com/authlete/common/dto/Service.html#setAuthorityHints-java.net.URI:A-))

At least one pair of trust anchor and its JWK Set must be registered. Otherwise, the service cannot trust any trust chain. (cf. [Service.setTrustAnchors(TrustAnchor[])](https://authlete.github.io/authlete-java-common/com/authlete/common/dto/Service.html#setTrustAnchors-com.authlete.common.dto.TrustAnchor:A-))

At least one private key dedicated to OpenID Federation must be registered. Otherwise, the service cannot sign entity statements. (cf. [Service.setFederationJwks(String)](https://authlete.github.io/authlete-java-common/com/authlete/common/dto/Service.html#setFederationJwks-java.lang.String-))

At least either of automatic client registration or explicit client registration must be supported. Otherwise, the service cannot register federation clients. (cf. [Service.setSupportedClientRegistrationTypes(ClientRegistrationType[])](https://authlete.github.io/authlete-java-common/com/authlete/common/dto/Service.html#setSupportedClientRegistrationTypes-com.authlete.common.types.ClientRegistrationType:A-))

![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_authlete_service_settings.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_api_configuration.png)
...
![](https://storage.googleapis.com/authlete-website/img/developers/oidcfed/oidcfed_api_registration.png)
...
The next action that the implementation of the federation registration endpoint
      should take after getting a response from the Authlete API.
...
The content that the implementation of the federation registration endpoint
      should use when it constructs a response.

In a successful case, the value of the `responseContent` response
      parameter is the entity statement of the newly registered client in JWT format.

Information about the newly registered client in JSON object format.
...
1. If a client having the numeric ID was not found, but if the “[Client ID Alias](/kb/oauth-and-openid-connect/client-id-alias)” feature of the service is enabled, Authlete interprets the specified client identifier as an alias and searches the database for a client having the alias.
1. If a client having the alias was not found, but if the “OpenID Federation” feature of the service is enabled, Authlete interprets the specified client identifier as an entity ID and searches the database for a client having the entity ID.
1. If a client having the entity ID was not found, but if the service supports automatic client registration, Authlete tries to resolve a trust chain of the client.
1. If the trust chain resolution succeeds, Authlete applies the combined metadata policy of the trust chain to the metadata of the client.
1. Authlete checks whether the client metadata contains the `client_registration_types` client metadata and it includes `automatic`.
1. Authlete validates the client metadata to ensure that the client can be registered to the service.
1. Authlete performs request authentication for the OAuth/OIDC request.
1. Finally, Authlete registers the client and continues to process the OAuth/OIDC request.
...
If a client having the numeric ID was not found, but if the “[Client ID Alias](/kb/oauth-and-openid-connect/client-id-alias)” feature of the service is enabled, Authlete interprets the specified client identifier as an alias and searches the database for a client having the alias.
...
Authlete checks whether the client metadata contains the `client_registration_types` client metadata and it includes `automatic`.
...
1. Authlete checks whether the service supports automatic client registration and whether the client’s `client_registration_types` metadata contains `automatic`. If these conditions are not satisfied, an error is returned.
1. Authlete validates the trust chain specified by the `trust_chain` request parameter. Especially, the entity ID of the entity configuration in the trust chain must match the entity ID of the existing client.
1. Authlete applies the combined metadata policy of the trust chain to the client metadata in the trust chain.
1. Authlete checks whether the client metadata contains the `client_registration_types` client metadata and it includes `automatic`.
1. Authlete validates the client metadata to ensure that the client can be updated with the metadata.
1. Authlete updates metadata of the client.
1. Authlete continues to process the OAuth/OIDC request.

If the “OpenID Federation” feature of the service is not enabled, Authlete does not try to update trust chains.

Authlete checks whether the service supports automatic client registration and whether the client’s `client_registration_types` metadata contains `automatic`. If these conditions are not satisfied, an error is returned.

Authlete validates the trust chain specified by the `trust_chain` request parameter. Especially, the entity ID of the entity configuration in the trust chain must match the entity ID of the existing client.
...
1. If the “OpenID Federation” feature of the service is not enabled, Authlete does not try to update trust chains.
1. Authlete checks whether the current trust chain of the client has expired. If the trust chain has not expired, Authlete does not try to update the trust chain.
1. If the current trust chain has expired but the service does not support automatic client registration, the client is **deleted** and the OAuth/OIDC request fails.
1. If the current trust chain has expired but `automatic` is not included in the `client_registration_types` client metadata, the client is **deleted** and the OAuth/OIDC request fails.
1. Authlete builds a trust chain from the entity ID of the client from scratch.
1. Authlete applies the combined metadata policy of the trust chain to the client metadata in the trust chain.
1. Authlete checks whether the client metadata contains the `client_registration_types` client metadata and it includes `automatic`.
1. Authlete validates the client metadata to ensure that the client can be updated with the metadata.
1. Authlete updates metadata of the client.
...
If the current trust chain has expired but `automatic` is not included in the `client_registration_types` client metadata, the client is **deleted** and the OAuth/OIDC request fails.
