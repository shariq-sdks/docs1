---
title: "Signing Up to Authlete"
description: "Learn how to set up your Authlete Account, create services and clients, and navigate the Management Console. This guide covers everything from account registration to configuring your first authorization server, helping you get started quickly with OAuth and OpenID Connect."
---
<Info>
...
1. Authlete Management Console Overview
...
Start by clicking “Register” on the Authlete website.
...
You must read and agree to Authlete’s Privacy Policy in order to register an account, so once you have checked the box, click “Register”.
...
- **[OAuth 2.0 Basics - API Tutorials](/developers/tutorial/oauth/)**: Call the Authlete APIs directly using the curl command etc. to learn the basics of how Authlete works.
- **[Using Demo Authorization Server](/developers/tutorial/signup/)**: Deploy an authorization server that works as a frontend for the Authlete APIs and test the OAuth and OpenID Connect flows.

> **Ready to get started?** **Sign Up for an Authlete Account** and unlock all the features of Authlete!
