...
### [OAuth 2.0 Basics](http://localhost:1314/developers/tutorial/oauth/)
A tutorial to understand how OAuth 2.0 authorization server leverages Authlete APIs.
### [OIDC Basics](http://localhost:1314/developers/tutorial/oidc/)
A tutorial to understand how OpenID Connect identity provider leverages Authlete APIs.
### [Getting Started with the Authlete APIs in Java](http://localhost:1314/developers/tutorial/getting_started_java/)
Learn how to use the Authlete APIs to enable a Java web application as an OAuth Authorization Server and Resource Server.
### [Financial-grade API (FAPI) Basics](http://localhost:1314/developers/tutorial/fapi/)
A tutorial to configure Authlete to build a Financial-grade API (FAPI) compliant authorization server.
### [FAPI Basics Supplement: Integration with Reference Implementations](http://localhost:1314/developers/tutorial/fapi_with_ref_impl/)
...
### [Financial-grade Amazon API Gateway](http://localhost:1314/developers/tutorial/financial_grade_apigateway/)
...
### [Integration with External IdPs](http://localhost:1314/developers/tutorial/idp/)
An article that explains how to integrate Authlete with external IdPs.
### [Amazon Cognito and Latest OAuth/OIDC Specifications](http://localhost:1314/developers/tutorial/cognito/)
