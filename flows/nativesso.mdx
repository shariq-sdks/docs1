---
title: 'Native SSO - Authlete'
description: 'Explanation about "OpenID Connect Native SSO for Mobile Apps 1.0" specification and Authlete's implementation.'
---
...
and `{{device_secret}}` with actual values.
