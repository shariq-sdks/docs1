...
description: " All Authlete API endpoints require authentication using your service credentials. This guide explains the different authentication methods and how to use them securely."
---
