#!/usr/bin/env python3
"""
Fix Extra Quotes Script
Fixes the specific pattern of extra quotes in titles and descriptions
"""
...
def fix_file(file_path):
    """Fix extra quotes in a single file"""
    try:
        ...
        # Fix the specific pattern: title: "'text'" -> title: 'text'
        content = re.sub(r"title: '\s*'([^']+)'\s*'", r"title: '\1'", content)
        
        # Fix the specific pattern: description: "'text'" -> description: 'text'
